...
\newcommand{\vepsianrose}{%
	\begin{figure}[h!]
		\vspace*{-77mm}
		\hspace*{8.15cm}\includegraphics[scale=0.12]{vepsrosedr}
	\end{figure}
	\vspace*{4.0cm}
}
...
%\input{лидь2017/антистапель}
%\input{лидь2017/автовыброска}
%\input{лидь2017/заключение}
%
% ЧАСТЬ 4 - ПЕСЬ 2018
%
%\input{песь2018/часть4}
%\input{песь2018/аннотация}
%\afterpage{\blankpage}
%\input{песь2018/раскрась_это_черным}
%
% ЧАСТЬ 5 - ЧАГОДОЩА 2019
%
%\input{чагодоща2019/часть5}
%\input{чагодоща2019/аннотация}
%\afterpage{\blankpage}
%\input{чагодоща2019/cold_as_ice}
%
% ЭПИЛОГ
\input{epilog}
%
...
\input{coordinates}
%
%\bibliographystyle{apalike2}%{plain}%{alpha}%
%\bibliographystyle{abbrvnat} % best!
